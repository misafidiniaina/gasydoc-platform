...
export default function SignupPage() {
  ...
  async function handleSignup() {
    ...
    if (data.user) {
      if (role === "professional") {
        ...
        await supabase
          .from("clinics")
          .insert({ owner_id: data.user.id, name: "" });
      }
    }
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative scale-93 z-10 w-full flex flex-col items-center">
          ...
          <div className="text-center">
            <p className="text-white text-2xl font-light italic leading-[90%]">
              <span className="text-[#1EEF7C] font-bold text-4xl font-serif leading-[90%]">
                "
              </span>{" "}
      ...
      {/* Right panel — form */}
      <div className="flex-1 flex items-center justify-center px-35 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            <button
              ...
              className={`p-3 rounded-xmd border-2 text-sm font-medium transition-colors ${
                role === "professional"
